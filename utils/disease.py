disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        ...
        <br/><br/> 1. Apple scab overwinters primarily in fallen leaves and in the soil. Disease development is 
    ...
    'Grape___Black_rot': """ <b>Crop</b>: Grape <br/>Disease: Black Rot<br/>
        ...
        <br/> 3. The infection becomes visible after 8 to 25 days. When the weather is wet, spores can be released 
        the entire spring and summer providing continuous infection. 
